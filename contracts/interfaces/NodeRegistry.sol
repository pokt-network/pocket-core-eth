...
contract NodeRegistry {
     ...
     * @param bytes32 _endpoint - The endpoint information in multi addr format.
     */
    function register(bytes8[] _networks, bytes32 _endpoint) public returns(bytes32) {}
    /*
     * @dev Verify existence of a given Node nonce
     * @param bytes32 _nodeNonce - Nonce to verify against.
     */
    function isNode(bytes32 _nodeNonce) public returns(bool) {}
    /*
     ...
     */
    function isOwner(address _possibleOwner, bytes32 _nodeNonce) public returns(bool) {}
}
